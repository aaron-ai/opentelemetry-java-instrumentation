...
include(":instrumentation:rocketmq-client-java-5.0.1:javaagent")
include(":instrumentation:rocketmq-client-java-5.0.1:library")
include(":instrumentation:rocketmq-client-java-5.0.1:testing")
